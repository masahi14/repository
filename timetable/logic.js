...
(function (root) {
   ...
   * 区分3（4〜9人）の20分未満の点数は、当初書籍の転記で96点としていたが、
   * レセプトサポートセンターへの確認及びレセコンでの実地入力確認により、
   * 217点が正しいことが判明したため訂正済み（2026年）。他の区分は書籍の転記のまま
   * （区分3以外はレセコン等での再確認をまだ行っていない点に留意）。
   */
  var VISIT_FEE_TABLE = [
    { maxCount: 1, category: 1, over20: 1100, under20: 287 },
    { maxCount: 3, category: 2, over20: 410, under20: 217 },
    { maxCount: 9, category: 3, over20: 310, under20: 217 },
